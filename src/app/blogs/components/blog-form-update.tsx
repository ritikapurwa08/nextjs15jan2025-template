...
import { UseUpdateBlogHook } from "../hooks/blog-update-hook";
import { Id } from "../../../../convex/_generated/dataModel";
import { UseGetBlogByIdHook } from "../hooks/get-blog-by-id-hook";
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button variant="outline" disabled={updatingBlog}>
          Update
        </Button>
      </DialogTrigger>
